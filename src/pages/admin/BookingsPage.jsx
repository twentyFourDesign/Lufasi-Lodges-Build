...
export default function BookingsPage() {
    ...
    useEffect(() => {
        ...
        if (filters.status) {
            result = result.filter(b => (b.bookingStatus || b.status) === filters.status);
        }

        if (filters.search) {
            const search = filters.search.toLowerCase();
            result = result.filter(b =>
                (b.GuestDirectory?.fullName || b.guestName || "").toLowerCase().includes(search) ||
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg border border-gray-100 shadow-sm">
                    <div className="p-4 md:p-5 border-b border-gray-100 flex justify-between items-center">
                        <h2 className="text-lg font-semibold text-[#333333]">All Bookings</h2>
                                ...
                                <table className="w-full text-sm">
                                    ...
                                    <thead>
                                        <tr className="bg-[#333333] text-white">
                                            <th className="py-3 px-4 text-left font-medium rounded-l-lg">Booking ID</th>
                                            <th className="py-3 px-4 text-left font-medium">Guest Name</th>
                                            <th className="py-3 px-4 text-left font-medium">Dates</th>
                                            <th className="py-3 px-4 text-left font-medium">Pod Name</th>
                                    ...
                                    <tbody>
                                        {paginatedBookings.map((booking, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="py-3 px-4 text-[#333333]">
                                                    {booking.GuestDirectory?.fullName || booking.guestName || "Unknown"}
                                                </td>
                                                ...
                                                <td className="py-3 px-4">
                                                    <span className={`font-medium capitalize ${getStatusBadge(booking.bookingStatus || booking.status)}`}>
